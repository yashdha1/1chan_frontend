...
const nextConfig = {
  ...
  async rewrites() {
    ...
    return [
      { source: "/api/v1/free_auth/:path*", destination: `${AUTH}/api/v1/free_auth/:path*` },
      { source: "/api/v1/auth/:path*", destination: `${AUTH}/api/v1/auth/:path*` },
      { source: "/api/v1/posts/:path*", destination: `${POST}/api/v1/posts/:path*` },
      { source: "/api/v1/feed/:path*", destination: `${FEED}/api/v1/feed/:path*` },
      { source: "/api/v1/notifications/:path*", destination: `${NOTIF}/api/v1/notifications/:path*` },
    ];
  },
};
